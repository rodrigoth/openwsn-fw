...
//static const uint8_t addr_64b_node[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0xb0, 0x68};// M-229 Grenoble
//static const uint8_t addr_64b_sink[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xde, 0xb2, 0x68}; // M-226 Grenoble
//static const uint8_t addr_64b_sink[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd3, 0x93, 0x77}; // M-227 Grenoble


//static const uint8_t addr_64b_sink[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0x99, 0x50}; // A-228 Grenoble
//static const uint8_t addr_64b_sink[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xb5, 0x61}; // A-226 Grenoble
//static const uint8_t addr_64b_node[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd6, 0x96, 0x63}; // A-227 Grenoble
...
//static const uint8_t addr_64b_node[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xdd, 0x85, 0x61}; // A-224 Grenoble
//05-43-32-ff-03-da-b5-61

//static const uint8_t addr_64b_228[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0x99, 0x50}; // A-226 Grenoble
//static const uint8_t addr_64b_227[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd6, 0x96, 0x63}; // A-227 Grenoble
...
static const uint8_t addr_64b_225[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd8, 0xb5, 0x58}; // A-225 Grenoble
static const uint8_t addr_64b_215[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xdb, 0xa4, 0x60}; // A-215 Grenoble
static const uint8_t addr_64b_199[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd9, 0x89, 0x61}; // A-199 Grenoble

static const uint8_t addr_64b_200[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xdd, 0x35, 0x87}; // A-200 Grenoble
static const uint8_t addr_64b_207[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xa9, 0x51}; // A-207 Grenoble
static const uint8_t addr_64b_208[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xd8, 0x16, 0x85}; // A-208 Grenoble
static const uint8_t addr_64b_216[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xb4, 0x59}; // A-216 Grenoble
static const uint8_t addr_64b_210[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0xb7, 0x59}; // A-210 Grenoble
static const uint8_t addr_64b_211[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xd9, 0x23, 0x86}; // A-211 Grenoble
static const uint8_t addr_64b_212[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd8, 0x95, 0x63}; 
static const uint8_t addr_64b_213[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd6, 0x98, 0x61}; 
static const uint8_t addr_64b_202[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0x99, 0x58}; // A-202
static const uint8_t addr_64b_203[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xa1, 0x50}; // A-203 Grenoble
static const uint8_t addr_64b_204[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xd7, 0x20, 0x87}; // A-204 Grenoble
static const uint8_t addr_64b_205[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0x86, 0x62}; // A-205 Grenoble




//static const uint8_t addr_64b_209[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd9, 0x91, 0x61}; // A-209 Grenoble
//static const uint8_t addr_64b_201[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xda, 0x28, 0x87}; // 201 Grenoble
//static const uint8_t addr_64b_196[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xa9, 0x60}; // A-196 Grenoble
//static const uint8_t addr_64b_198[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0xb2, 0x59}; // A-198 Grenoble
//static const uint8_t addr_64b_195[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd9, 0x94, 0x60}; // A-195 Grenoble
//static const uint8_t addr_64b_192[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0x97, 0x58}; // A-192 Grenoble
//static const uint8_t addr_64b_194[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xde, 0x96, 0x64}; // A-194 Grenoble

//static const uint8_t addr_64b_214[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0x87, 0x61};  problem

//static const uint8_t addr_64b_222[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xd8, 0x20, 0x84}; // A-222 Grenoble
//static const uint8_t addr_64b_220[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xdc, 0xa8, 0x61}; // A-220 Grenoble
//static const uint8_t addr_64b_197[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd5, 0xa2, 0x62}; // A-197 Grenoble
//static const uint8_t addr_64b_206[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd8, 0x89, 0x59}; // A-206 Grenoble
//static const uint8_t addr_64b_190[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xda, 0x87, 0x61}; // A-190 Grenoble
//static const uint8_t addr_64b_193[] = {0x05, 0x43, 0x32, 0xff, 0x04, 0xd8, 0x18, 0x85}; // A-193 Grenoble
