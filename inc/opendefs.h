...
static const uint8_t addr_64b_sink[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xd7, 0xa5, 0x62};//  A-96 Grenoble
static const uint8_t addr_64b_node[] = {0x05, 0x43, 0x32, 0xff, 0x03, 0xdc, 0xb0, 0x58}; // A-98 Grenoble
